...
from speechvalley.utils.utils import load_batched_data
from speechvalley.utils.utils import describe
from speechvalley.utils.utils import getAttrs
from speechvalley.utils.utils import output_to_sequence
from speechvalley.utils.utils import list_dirs
from speechvalley.utils.utils import logging
from speechvalley.utils.utils import count_params
from speechvalley.utils.utils import target2phoneme
from speechvalley.utils.utils import get_edit_distance
from speechvalley.utils.taskUtils import get_num_classes
from speechvalley.utils.taskUtils import check_path_exists
from speechvalley.utils.taskUtils import dotdict
from speechvalley.utils.functionDictUtils import model_functions_dict
from speechvalley.utils.functionDictUtils import activation_functions_dict
from speechvalley.utils.functionDictUtils import optimizer_functions_dict

from speechvalley.models.resnet import ResNet
from speechvalley.models.brnn import BiRNN
...
flags.DEFINE_string('level', 'phn', 'set the task level, phn, cha, or seq2seq, seq2seq will be supported soon')#junying-todo
...
flags.DEFINE_string('datadir', '/home/frank/github/data/TIMIT/DATA', 'set the data root directory')#junying-todo
flags.DEFINE_string('logdir', '/home/frank/github/log/timit', 'set the log directory')#junying-todo
...
train_mfcc_dir = os.path.join(os.path.join(os.path.join(datadir, level), 'train'), 'mfcc')
train_label_dir = os.path.join(os.path.join(os.path.join(datadir, level), 'train'), 'label')
test_mfcc_dir = os.path.join(os.path.join(os.path.join(datadir, level), 'test'), 'mfcc')
test_label_dir = os.path.join(os.path.join(os.path.join(datadir, level), 'test'), 'label')
